...
exports.CatalystStratusError = exports.CatalystNoSQLError = exports.CatalystPipelineError = exports.CatalystQuickMLError = exports.CatalystSmartbrowzError = exports.CatalystCircuitError = exports.CatalystConnectorError = exports.CatalystZiaError = exports.CatalystZCQLError = exports.CatalystUserManagementError = exports.CatalystSearchError = exports.CatalystQueueError = exports.CatalystPushNotificationError = exports.CatalystGQLError = exports.CatalystFunctionsError = exports.CatalystFilestoreError = exports.CatalystEmailError = exports.CatalystDatastoreError = exports.CatalystCronError = exports.CatalystCacheError = exports.CatalystAuthError = exports.CatalystAppError = exports.CatalystApiError = exports.PrefixedCatalystError = void 0;
...
class CatalystApiError extends PrefixedCatalystError {
    constructor(code, message, value, statusCode) {
        super('api', code, message, value, statusCode);
    }
}
...
class CatalystSmartbrowzError extends PrefixedCatalystError {
    constructor(code, message, value) {
        super('smartbrowz', code, message, value);
    }
}
exports.CatalystSmartbrowzError = CatalystSmartbrowzError;
class CatalystQuickMLError extends PrefixedCatalystError {
    constructor(code, message, value) {
        super('quickml', code, message, value);
    }
}
exports.CatalystQuickMLError = CatalystQuickMLError;
class CatalystPipelineError extends PrefixedCatalystError {
    constructor(code, message, value) {
        super('pipeline', code, message, value);
    }
}
exports.CatalystPipelineError = CatalystPipelineError;
class CatalystNoSQLError extends PrefixedCatalystError {
    constructor(code, message, value) {
        super('nosql', code, message, value);
    }
}
exports.CatalystNoSQLError = CatalystNoSQLError;
class CatalystStratusError extends PrefixedCatalystError {
    constructor(code, message, value) {
        super('stratus', code, message, value);
    }
}
exports.CatalystStratusError = CatalystStratusError;
