...
import { ApiResponse, ChannelLiveCountResponse, GetAllChannelsResponse, GetChannelResponse, TokenResponse } from './utils/interfaces';
/**
...
export declare class DataStreams implements Component {
     ...
     * ```
     */
    publishData(channelId: string, data: Record<string, unknown>): Promise<boolean>;
    /**
