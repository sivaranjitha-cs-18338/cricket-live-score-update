...
exports.CONSTANTS = {
    ACCOUNTS_ORIGIN: (0, helpers_1.envOverride)('X_ZOHO_CATALYST_ACCOUNTS_URL', 'https://accounts.zoho.com'),
    ACCOUNTS_PORTAL_ORIGIN: (0, helpers_1.envOverride)('CATALYST_PORTAL_DOMAIN', 'https://accounts.zohoportal.com'),
    CATALYST_ORIGIN: (0, helpers_1.envOverride)('X_ZOHO_CATALYST_CONSOLE_URL', 'https://api.catalyst.zoho.com'),
    IS_LOCAL: (0, helpers_1.envOverride)('X_ZOHO_CATALYST_IS_LOCAL', 'false'),
    IS_APM: (0, helpers_1.envOverride)('X_ZOHO_CATALYST_IS_APM', 'false'),
    STRATUS_SUFFIX: (0, helpers_1.envOverride)('X_ZOHO_STRATUS_RESOURCE_SUFFIX', '.zohostratus.com'),
    REQ_RETRY_THRESHOLD: (0, helpers_1.envOverride)('X_ZOHO_CATALYST_REQ_RETRY', 2),
